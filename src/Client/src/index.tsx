...
import { IdentityView, LoginView, SignUpView, ResetPasswordView, ActivateEmailView } from './User'
        ...
        <Router history={history}>
            <App>
                <Switch>
                    ...
                    <UnauthRoute path={Urls.ACTIVATE_EMAIL} component={ActivateEmailView} />
